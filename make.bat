...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=covid-feature-selection
SET SUPPORT_LIBRARY = covid_feature_selection
SET ENV_NAME=covid-feature-selection
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/covid-feature-selection*.tar.bz2
